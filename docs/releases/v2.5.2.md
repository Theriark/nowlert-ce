...
- Published images use an immutable commit-addressed GitHub raw URL for outbound card artwork. `NOWLERT_ICON_BASE_URL` remains available for mirrors and branded clones.
