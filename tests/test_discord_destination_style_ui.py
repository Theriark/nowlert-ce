...
def test_discord_destination_uses_user_facing_message_style_selector():
    ...
    assert 'value: "classic", text: "Classic Embed"' in script
    ...
    assert 'Modern Card uses responsive structured sections; Classic Embed uses the traditional Discord embed layout.' in script
