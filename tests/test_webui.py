...
def test_webui_markup_is_semantic_external_and_complete():
    ...
    assert inspector.scripts == [
        "/ui/app.js?v=20260919-r36",
        "/ui/enhancements.js",
        "/ui/qa_patch.js?v=20260919-r36",
        "/ui/i18n.js",
        "/ui/dashboard.js",
    ]
    assert inspector.stylesheets == [
        "/ui/styles.css",
        "/ui/enhancements.css",
        "/ui/qa_patch.css?v=20260919-r36",
        "/ui/professional.css",
    ]
...
def test_round19_served_html_cache_busts_round18_acceptance_assets():
    ...
    assert 'name="nowlert-ui-build" content="20260919-r36"' in markup
    assert "/ui/app.js?v=20260919-r36" in markup
    assert "/ui/qa_patch.css?v=20260919-r36" in markup
