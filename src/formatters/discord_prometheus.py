...
class PrometheusDiscordFormatter(DiscordCardFormatter):
    ...
    def format_classic_rich(
        self,
        notification: Notification,
    ) -> dict:
        """Render Prometheus through the shared rich Classic hierarchy."""
        ...
        details.append(
            DiscordFact("🏷️", "Labels", labels, False)
        )
        details.append(
            DiscordFact(
                "🔔",
                "Reason",
                metadata.get("notification_reason"),
                False,
            )
        )
        ...
        if (
            state.casefold() == "resolved"
            and notification.end_time
        ):
            details.append(
                DiscordFact(
                    "🏁",
        ...
        payload = self._render_discord_rich_classic(
            DiscordCardData(
                notification=notification,
                source="prometheus",
